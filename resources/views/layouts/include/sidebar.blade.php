       ...
       <ul class="space-y-2 font-medium">
          ...
          <li>
             <a href="/" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                <span class="bi bi-file-break"> Student Landing</span>
             </a>
          </li>
          <li>
          ...
          <li>
            <a href="management" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
               <span class="bi bi-bookmarks">Department</span>
            </a>
         </li>
          <li>
            <a href="record" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
               ...
               <span class="flex-1 ms-3 whitespace-nowrap">Attenders record</span>
            </a>
         </li>
          <li>
